...
//        dataHolder, currentPage * perPage, if (toIndex > dataHolder.size) dataHolder.size else toIndex
//      )
//      runOnUiThread {
//        refreshAdapter()
//        loading.closeDialog()
...
//            dataHolder.add(
//              Withdraw(
//                deposit.getLong("Value"), "Deposit", Helper.getMillis(deposit.getString("Date").trim())
//              )
//            )
//          }
//        }
...
//            dataHolder.add(
//              Withdraw(
//                transfer.getLong("Value"), "Transfer", Helper.getMillis(transfer.getString("Date").trim())
//              )
//            )
//          }
//        }
//      }
//
//    } while (token.isNotBlank() && (deposits.length() > 0 || transfers.length() > 0))
//
...
//    if (!token.isNullOrBlank()) body.add("Token", token)
